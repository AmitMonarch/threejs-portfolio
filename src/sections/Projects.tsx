    ...
    <section className="c-space my-20">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
        <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
          ...
          <div
            className="backdrop-filter backdrop-blur-3xl w-fit rounded-lg overflow-hidden relative z-10"
          ...
          <div className="flex flex-col gap-5 text-white-600 my-5 relative z-10">
            ...
            <p className="animatedText text-[#afb0b6]">
          ...
          <div className="flex items-center justify-between flex-wrap gap-5 relative z-10">
            ...
            <a
              ...
              rel="noreferrer"
            >
              <p className="text-[#afb0b6]">Check Live Site</p>
